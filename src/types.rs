...
pub struct FundsEntry {
    ...
    /// | family | convention |
    /// | -- | -- |
    /// | funds movement — this type, [`Withdrawal`] | positive magnitude, direction in a categorical field |
    /// | funding settlement — [`AccountFunding`] | **signed**: negative paid, positive received |
    ///
